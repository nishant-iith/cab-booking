...
public:
    ...
    cabBooking()
    {
        allCabs.push_back(new SUV(234567, "Meera Verma", locations[rand() % locations.size()], true));
        allCabs.push_back(new Intercity(535454, "Rahul Mishra", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(876123, "Priya Singh", locations[rand() % locations.size()], true));
        allCabs.push_back(new SUV(342567, "Arjun Kapoor", locations[rand() % locations.size()], true));
        allCabs.push_back(new Intercity(998877, "Neha Sharma", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(111222, "Aisha Khan", locations[rand() % locations.size()], true));
        allCabs.push_back(new Intercity(654321, "Kartik Verma", locations[rand() % locations.size()], true));
        allCabs.push_back(new SUV(777888, "Simran Kaur", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(444555, "Vikas Yadav", locations[rand() % locations.size()], true));
        allCabs.push_back(new Intercity(123456, "Ananya Sharma", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(987654, "Rohit Kapoor", locations[rand() % locations.size()], true));
        allCabs.push_back(new Intercity(876543, "Ravi Malhotra", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new SUV(345678, "Pooja Sharma", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(567890, "Varun Kapoor", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Intercity(432109, "Kritika Singh", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new SUV(555666, "Aryan Verma", locations[rand() % locations.size()], true));
        allCabs.push_back(new Sedan(678901, "Tanvi Kapoor", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Intercity(210987, "Rishi Singh", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Sedan(789012, "Priyanka Yadav", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new SUV(890123, "Sagar Verma", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Intercity(321098, "Kajal Sharma", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Sedan(654323, "Arjun Yadav", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new SUV(111999, "Neha Kapoor", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Intercity(222333, "Ankit Verma", locations[rand() % locations.size()], rand() % 2));
        allCabs.push_back(new Sedan(333444, "Preeti Singh", locations[rand() % locations.size()], rand() % 2));
    }
    ...
    void cabsAvailable(string userLocation)
    {
        ...
        else
        {
            ...
            cout << "------------------------------------------------------------------------------" << endl;
            int userRating;
            cout << "Kindly evaluate your experience: \nChoose 1 for less satisfactory, 5 for highly satisfactory" <<endl;
            cin>>userRating;
            ratingSystem.loadRatingsFromCSV("cab_ratings.csv");
            ratingSystem.addRating(cabNum,userRating);
            ratingSystem.saveRatingsToCSV("cab_ratings.csv");
